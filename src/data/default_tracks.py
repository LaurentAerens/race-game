...
def create_emerald_ring() -> Circuit:
    ...
    points = [
        ...
        (-150, -260),
        (100, -250),
        (350, -240),  # Main Straight (Nodes 0-3)
        (500, -180),
        (550, -50),
        (450, 80),  # Turn 1-2 Fast Sweeper
        (300, 100),
        (150, 180),
        (100, 300),  # Technical Infield
        (-50, 350),
        (-200, 300),
        (-250, 150),  # Turn 6-8 Complex
        (-450, 100),
        (-550, -50),
        (-500, -180),  # Final Hairpin onto Straight (Nodes 13-15)
    ]
...
def create_autodromo_velocita() -> Circuit:
    ...
    points = [
        ...
        (-250, -320),
        (100, -320),
        (450, -320),  # Main Straight (Nodes 0-3)
        (620, -260),
        (660, -160),
        (580, -90),  # Chicane (Nodes 4-6)
        (480, 20),
        (420, 140),
        (380, 280),  # Curva Grande Sweeper (Nodes 7-9)
        (200, 340),
        (-100, 340),
        (-350, 320),  # Back Straight (Nodes 10-12)
        (-480, 250),
        (-540, 150),
        (-580, 30),  # S-Curve Complex (Nodes 13-15)
        (-660, -80),
        (-640, -220),  # Curva Parabolica (Nodes 16-17)
    ]
...
def create_oasis_grand_prix() -> Circuit:
    ...
    points = [
        ...
        (-100, -260),
        (150, -260),
        (400, -260),  # Start / Finish Straight (Nodes 0-3)
        (540, -230),
        (560, -120),
        (460, -50),  # Turn 1-2 Heavy Braking Hairpin (Nodes 4-6)
        (380, 40),
        (380, 160),  # Acceleration Chute (Nodes 7-8)
        (480, 230),
        (420, 320),
        (280, 320),  # Hard 90-Degree Corner (Nodes 9-11)
        (140, 280),
        (30, 200),
        (-60, 200),  # Infield Stop-and-Go Chicane (Nodes 12-14)
        (-220, 240),
        (-380, 200),  # Back Straight (Nodes 15-16)
        (-490, 100),
        (-520, -40),
        (-450, -180),  # Final Deceleration Hairpin (Nodes 17-19)
    ]
...
def create_vortex_aero_ring() -> Circuit:
    ...
    points = [
        (-380, -220),
        (-100, -220),
        (180, -220),  # Pit Straight (Nodes 0-2)
        (380, -170),
        (520, -70),  # Abbey High-Speed Sweeper (Nodes 3-4)
        (460, 60),
        (340, 160),
        (200, 200),
        (60, 280),  # Flowing Esses (Nodes 5-8)
        (-80, 320),
        (-240, 300),  # Chapel Curve Exit (Nodes 9-10)
        (-380, 220),
        (-500, 100),  # Hangar Fast Arc (Nodes 11-12)
        (-560, -30),
        (-520, -140),
        (-460, -190),  # Sweeping Carousel (Nodes 13-15)
    ]
...
def create_apex_park() -> Circuit:
    ...
    points = [
        ...
        (0, -200),
        (300, -200),
        (450, -150),  # Main Straight
        (500, 0),
        (400, 100),
        (200, 120),  # Turn 1-3 Chicane
        (100, 250),
        (0, 300),
        (-150, 250),  # Hairpin
        (-250, 100),
    ...
    circuit.drs_zones = [{"name": "Main Straight", "start_s": 0.0, "end_s": circuit.length * 0.25}]
...
def create_harbor_city() -> Circuit:
    ...
    points = [
        (-250, -150),
        (0, -150),
        (250, -150),  # Harbor Boulevard
        (350, -100),
        (350, 50),
        (300, 150),  # 90-degree Marina Turns
        (150, 180),
        (50, 220),
        (-100, 200),  # Casino Square
        (-200, 150),
        (-300, 50),
        (-350, -50),  # Tunnel & Swimming Pool
    ]
    circuit.sectors = [0.32, 0.68, 1.0]
    circuit.set_control_points(points)
    circuit.set_pit_lane_endpoints(entry_node=11, exit_node=1, side="INSIDE", offset_m=12.0)
    circuit.drs_zones = [{"name": "Harbor Straight", "start_s": 0.0, "end_s": circuit.length * 0.22}]
...
def create_riviera_speedway() -> Circuit:
    ...
    points = [
        ...
        (-100, -220),
        (150, -220),
        (350, -200),  # Coastline Straight (Nodes 0-3)
        (480, -140),
        (510, -20),
        (440, 80),  # Coastal Sweeper (Nodes 4-6)
        (320, 140),
        (180, 180),
        (80, 260),  # Up-Hill Esse (Nodes 7-9)
        (-60, 300),
        (-200, 280),
        (-320, 180),  # Ridge Curve (Nodes 10-12)
        (-420, 80),
        (-490, -40),
        (-450, -160),  # Carousel Descent (Nodes 13-15)
    ]
...
def create_ardennes_forest() -> Circuit:
    ...
    points = [
        (-420, -280),
        (-180, -280),
        (80, -270),  # Pit Straight (Nodes 0-2)
        (220, -220),
        (280, -120),  # Turn 1 Hairpin (Nodes 3-4)
        (380, -30),
        (450, 80),
        (480, 220),  # Acceleration Blast (Nodes 5-7)
        (380, 320),
        (220, 350),
        (40, 320),  # Chicane (Nodes 8-10)
        (-140, 260),
        (-260, 160),
        (-360, 60),  # Fast Sweeper (Nodes 11-13)
        (-460, -40),
        (-520, -150),
        (-480, -230),  # Bus Stop & Final Turn (Nodes 14-16)
    ]
