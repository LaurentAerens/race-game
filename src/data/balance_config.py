...
TIER_DOMINANCE: Dict[int, TierDominanceWeight] = {
    1: TierDominanceWeight(
        1,
        "World Super Formula",
        driver_weight=0.18,
        car_weight=0.82,
        benchmark_driver_skill=85.0,
        benchmark_car_perf=235.0,
    ),
    2: TierDominanceWeight(
        2,
        "Continental Championship",
        driver_weight=0.32,
        car_weight=0.68,
        benchmark_driver_skill=70.0,
        benchmark_car_perf=145.0,
    ),
    3: TierDominanceWeight(
        3,
        "National Open Cup",
        driver_weight=0.50,
        car_weight=0.50,
        benchmark_driver_skill=55.0,
        benchmark_car_perf=75.0,
    ),
    4: TierDominanceWeight(
        4,
        "Junior Talent Series",
        driver_weight=0.70,
        car_weight=0.30,
        benchmark_driver_skill=40.0,
        benchmark_car_perf=45.0,
    ),
    5: TierDominanceWeight(
        5,
        "Karting Masters Academy",
        driver_weight=0.82,
        car_weight=0.18,
        benchmark_driver_skill=28.0,
        benchmark_car_perf=25.0,
    ),
}
...
class EconomySettings:
    ...
    prize_pools: Dict[int, List[float]] = field(
    ...
    starting_budgets: Dict[int, float] = field(
        default_factory=lambda: {1: 35_000_000.0, 2: 12_000_000.0, 3: 5_000_000.0, 4: 1_200_000.0, 5: 320_000.0}
    )
    ...
    driver_salary_tier_scale: Dict[int, float] = field(
        default_factory=lambda: {1: 3.5, 2: 2.0, 3: 1.0, 4: 0.35, 5: 0.12}
    )
...
class SponsorBalanceConfig:
    ...
    tier_appeal_points: Dict[int, float] = field(default_factory=lambda: {1: 35.0, 2: 18.0, 3: 4.0, 4: 2.0, 5: 1.0})
    # Tier cash payout multipliers applied to catalog base values
    tier_payout_multipliers: Dict[int, float] = field(
        default_factory=lambda: {1: 4.5, 2: 2.2, 3: 1.0, 4: 0.35, 5: 0.12}
    )
...
TIRE_CONFIGS: Dict[str, CompoundConfig] = {
    "HYPERSOFT": CompoundConfig(
        ...
        cliff_wear_pct=60.0,
        optimal_temp=105.0,
        wet_suitability=0.05,
        wet_capability=0.20,
    ),
    "SUPERSOFT": CompoundConfig(
        "Supersoft",
        "SS",
        "C4",
        (225, 30, 80),
...
class PartBuildConfig:
    tier_category_costs: Dict[int, Dict[str, float]] = field(
        default_factory=lambda: {
            1: {
                "BRAKES": 1_200_000.0,
            ...
            3: {"BRAKES": 85_000.0, "FRONT_WING": 120_000.0},
            4: {},
            5: {},
        }
    )
...
class PayDriverBalanceConfig:
    tier_sponsor_payout_base: Dict[int, float] = field(
        default_factory=lambda: {1: 1_800_000.0, 2: 750_000.0, 3: 280_000.0, 4: 85_000.0, 5: 30_000.0}
    )
...
class YoungDriverBalanceConfig:
    ...
    feeder_seat_cost_range: Dict[int, Tuple[float, float]] = field(
        default_factory=lambda: {
...
class BalanceSettingsRegistry:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "part_build": {"tier_category_costs": self.part_build.tier_category_costs},
            "pay_driver": {"tier_sponsor_payout_base": self.pay_driver.tier_sponsor_payout_base},
