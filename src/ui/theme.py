...
class UITheme:
    ...
    @classmethod
    def get_font(cls, base_size: int, bold: bool = False, font_name: str = "Segoe UI Emoji,Segoe UI Symbol,Segoe UI,Arial") -> pygame.font.Font:
        """
    ...
    def draw_button(surface: pygame.Surface, rect: pygame.Rect, text: str, font: pygame.font.Font, 
                    is_active: bool = False, is_hover: bool = False, is_disabled: bool = False) -> bool:
        if is_disabled:
            bg = (18, 22, 28)
