...
class DatabaseManager:
    ...
    def _seed_default_data(self, conn: sqlite3.Connection):
        ...
        teams_data = [
            ...
            {"name": "Storm Racing Team", "color": (20, 40, 140), "player": 0,
             "car": {"engine": 98.0, "aero": 98.0, "brakes": 97.0, "tire": 92.0, "fuel": 92.0, "rel": 96.0},
             "drivers": [
                 {"name": "Axel Lindqvist", "code": "LIN", "number": 1, "player": 0, "speed": 99, "braking": 98, "cornering": 98, "overtake": 98, "defend": 97, "tire": 93, "cons": 98, "wet": 98},
                 {"name": "Javier Morales", "code": "MOR", "number": 33, "player": 0, "speed": 86, "braking": 85, "cornering": 84, "overtake": 85, "defend": 88, "tire": 94, "cons": 83, "wet": 80}
             ]},

            # Tier 1: Scuderia Veloce (Italian Scarlet Red & Gold)
            {"name": "Scuderia Veloce", "color": (230, 25, 35), "player": 0,
             "car": {"engine": 97.0, "aero": 95.0, "brakes": 94.0, "tire": 82.0, "fuel": 84.0, "rel": 88.0},
             "drivers": [
                 {"name": "Lorenzo De Luca", "code": "DEL", "number": 16, "player": 0, "speed": 97, "braking": 96, "cornering": 96, "overtake": 94, "defend": 89, "tire": 82, "cons": 91, "wet": 89},
                 {"name": "Gabriel Duarte", "code": "DUA", "number": 55, "player": 0, "speed": 89, "braking": 90, "cornering": 88, "overtake": 87, "defend": 91, "tire": 89, "cons": 92, "wet": 85}
             ]},

            # Tier 2: Apex Dynamics (Cyan & Slate / Player Team)
            {"name": "Apex Dynamics", "color": (0, 220, 240), "player": 1,
             "car": {"engine": 91.0, "aero": 92.0, "brakes": 94.0, "tire": 88.0, "fuel": 87.0, "rel": 93.0},
             "drivers": [
                 {"name": "Leo Vance", "code": "VAN", "number": 4, "player": 1, "speed": 93, "braking": 95, "cornering": 92, "overtake": 92, "defend": 89, "tire": 87, "cons": 93, "wet": 90},
                 {"name": "Marcus Rossi", "code": "ROS", "number": 23, "player": 1, "speed": 86, "braking": 87, "cornering": 85, "overtake": 84, "defend": 83, "tire": 83, "cons": 86, "wet": 81}
             ]},

            # Tier 2: Solaris Grand Prix (Solar Papaya & Carbon)
            {"name": "Solaris Grand Prix", "color": (255, 135, 0), "player": 0,
             "car": {"engine": 93.0, "aero": 94.0, "brakes": 92.0, "tire": 89.0, "fuel": 88.0, "rel": 94.0},
             "drivers": [
                 {"name": "Liam Gallagher", "code": "GAL", "number": 27, "player": 0, "speed": 95, "braking": 94, "cornering": 95, "overtake": 92, "defend": 89, "tire": 89, "cons": 94, "wet": 92},
                 {"name": "Flynn MacIntyre", "code": "MAC", "number": 81, "player": 0, "speed": 89, "braking": 89, "cornering": 89, "overtake": 88, "defend": 86, "tire": 84, "cons": 89, "wet": 85}
             ]},

            # Tier 2: AeroStar Motorsport (Silver & Electric Teal)
            {"name": "AeroStar Motorsport", "color": (0, 165, 155), "player": 0,
             "car": {"engine": 92.0, "aero": 91.0, "brakes": 93.0, "tire": 96.0, "fuel": 92.0, "rel": 95.0},
             "drivers": [
                 {"name": "Julian Drake", "code": "DRA", "number": 44, "player": 0, "speed": 94, "braking": 96, "cornering": 93, "overtake": 95, "defend": 94, "tire": 97, "cons": 96, "wet": 98},
                 {"name": "Tyler Bennett", "code": "BEN", "number": 63, "player": 0, "speed": 90, "braking": 91, "cornering": 89, "overtake": 88, "defend": 87, "tire": 86, "cons": 88, "wet": 88}
             ]},

            # Tier 3: Vanguard Racing (British Racing Green & Lime)
            {"name": "Vanguard Racing", "color": (0, 110, 60), "player": 0,
             "car": {"engine": 86.0, "aero": 87.0, "brakes": 91.0, "tire": 93.0, "fuel": 89.0, "rel": 91.0},
             "drivers": [
                 {"name": "Roberto Vega", "code": "VEG", "number": 14, "player": 0, "speed": 94, "braking": 97, "cornering": 93, "overtake": 97, "defend": 98, "tire": 97, "cons": 95, "wet": 95},
                 {"name": "Colin Crawford", "code": "CRA", "number": 18, "player": 0, "speed": 79, "braking": 78, "cornering": 77, "overtake": 78, "defend": 76, "tire": 79, "cons": 76, "wet": 86}
             ]},

            # Tier 3: Titan Grand Prix (Deep Royal Blue & White)
            {"name": "Titan Grand Prix", "color": (30, 90, 200), "player": 0,
             "car": {"engine": 90.0, "aero": 81.0, "brakes": 84.0, "tire": 85.0, "fuel": 83.0, "rel": 89.0},
             "drivers": [
                 {"name": "Alexander Cross", "code": "CRO", "number": 5, "player": 0, "speed": 89, "braking": 90, "cornering": 87, "overtake": 88, "defend": 90, "tire": 90, "cons": 91, "wet": 87},
                 {"name": "Lucas Ferreira", "code": "FER", "number": 43, "player": 0, "speed": 82, "braking": 83, "cornering": 81, "overtake": 83, "defend": 80, "tire": 81, "cons": 83, "wet": 82}
             ]},

            # Tier 3: Nexus Performance (Cobalt Blue & Pink)
            {"name": "Nexus Performance", "color": (0, 140, 230), "player": 0,
             "car": {"engine": 85.0, "aero": 84.0, "brakes": 85.0, "tire": 83.0, "fuel": 83.0, "rel": 87.0},
             "drivers": [
                 {"name": "Antoine Laurent", "code": "LAU", "number": 10, "player": 0, "speed": 86, "braking": 87, "cornering": 85, "overtake": 85, "defend": 84, "tire": 84, "cons": 86, "wet": 85},
                 {"name": "Hugo Vasseur", "code": "VAS", "number": 31, "player": 0, "speed": 83, "braking": 84, "cornering": 82, "overtake": 85, "defend": 89, "tire": 82, "cons": 83, "wet": 83}
             ]},

            # Tier 4: Kestrel Tech (Gunmetal Grey & Scarlet)
            {"name": "Kestrel Tech", "color": (180, 40, 40), "player": 0,
             "car": {"engine": 87.0, "aero": 78.0, "brakes": 82.0, "tire": 76.0, "fuel": 80.0, "rel": 85.0},
             "drivers": [
                 {"name": "Henrik Weber", "code": "WEB", "number": 8, "player": 0, "speed": 87, "braking": 88, "cornering": 84, "overtake": 84, "defend": 82, "tire": 80, "cons": 89, "wet": 85},
                 {"name": "Viktor Lund", "code": "LUN", "number": 20, "player": 0, "speed": 81, "braking": 83, "cornering": 80, "overtake": 88, "defend": 92, "tire": 77, "cons": 78, "wet": 81}
             ]},

            # Tier 4: Neon Velocity (High-Vis Green & Black)
            {"name": "Neon Velocity", "color": (40, 210, 50), "player": 0,
             "car": {"engine": 81.0, "aero": 79.0, "brakes": 80.0, "tire": 84.0, "fuel": 84.0, "rel": 88.0},
             "drivers": [
                 {"name": "Jarno Koskinen", "code": "KOS", "number": 77, "player": 0, "speed": 85, "braking": 86, "cornering": 84, "overtake": 81, "defend": 80, "tire": 88, "cons": 89, "wet": 82},
                 {"name": "Jin Tanaka", "code": "TAN", "number": 24, "player": 0, "speed": 79, "braking": 80, "cornering": 78, "overtake": 77, "defend": 78, "tire": 80, "cons": 81, "wet": 79}
             ]}
        ]
            ...
            for d in t["drivers"]:
                cursor.execute(
                    """INSERT INTO drivers (team_id, name, code, number, is_player, speed, braking, cornering, overtaking, defending, tire_management, consistency, wet_skill)
                       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)""",
                    (team_id, d["name"], d["code"], d["number"], d["player"],
                     d["speed"], d["braking"], d["cornering"], d["overtake"], d["defend"], d["tire"], d["cons"], d["wet"])
                )
        conn.commit()
    ...
    def update_driver_attributes(self, driver_id: int, name: str, code: str, number: int, stats: Dict[str, float]) -> bool:
