...
class TestOSMImporter(unittest.TestCase):
    ...
    def test_shortest_path_on_roads(self):
        ...
        ways = [
            ...
            },
            {
                "id": 2,
                "type": "primary",
                "points_xy": [(100.0, 0.0), (100.0, 50.0), (100.0, 100.0)]
            },
            {
                "id": 3,
                "type": "residential",
                "points_xy": [(100.0, 100.0), (0.0, 100.0)]
            }
        ]
    ...
    def test_way_bbox_calculation(self):
        from src.editor.osm_importer import fetch_road_network
        # Test with dummy data
        ways = [
            {"id": 1, "name": "Way 1", "type": "residential", "points_xy": [(-50.0, 10.0), (120.0, 80.0)]}
        ]
